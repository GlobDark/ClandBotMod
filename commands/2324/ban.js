...
module.exports = {
    ...
    run: async (client, message, args) => {
        try {
            if (!message.member.permissions.has("BAN_MEMBERS") && !ownerID .includes(message.author.id)) return message.channel.send("**You Dont Have The Permissions To Ban Users! - [BAN_MEMBERS]**");
