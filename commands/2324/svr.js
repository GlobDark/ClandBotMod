...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (!message.member.permissions.has("MANAGE_GUILD") && !ownerID.includes(message.author.id)) return message.channel.send("You Don't Have Sufficient Permissions!- [MANAGE_GUILD]");
