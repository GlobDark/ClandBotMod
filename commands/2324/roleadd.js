...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if(!message.member.permissions.has(["MANAGE_ROLES"]) && !ownerID.includes(message.author.id)) return message.channel.send("You dont have permission to perform this command!")
